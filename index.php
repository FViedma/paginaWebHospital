				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							...
							<img src="img/logoblanco.jpg" alt="" style=" width: 120px" align="center"><br><br><br>
												</div>
									          ...
									          <table class="table table-striped" id="tblGrid">
									            ...
									            <tbody>
												  ...
												  El D.S. N°1258 del 3 de julio de 1948 da cuenta de que el Hospital Clínico Viedma obtuvo fondos para construir su Anfiteatro, según Ley del 15 de noviembre de 1984, destina fondos para construir la morgue.
									                ...
									                <td><p>En 1924 el Concejo Municipal modernizó las salas de hospitalización. Para el año 1929 el hospital tenía funcionando trece salas, dos pensionados, dos salas de operaciones (quirófanos), botica, droguería, consultorio y clínica dental propios para la atención de la población en general.
				...
				<div class="col-sm-4 col-md-4">
					<div class="team">
						...
						<div class="team-content">
							...
							<a href="http://webmail.hospitalviedma.org"><font style="text-transform: lowercase;">subdirmedica@hospitalviedma.org</font></a></span>
						</div>
					</div>
				</div><br>
				...
				<div class="col-sm-4">
					<div class="team">
						<div class="team-img">
							...
							<img class="img-responsive" src="./img/adelaamaya.jpeg" alt="" style="
									width: 87%">
						</div>
						<div class="team-content">
				...
				<div class="col-md-6 col-lg-6 col-xs-12">
					<div class="blog">
						...
						<div class="blog-content">
							...
							<a href=""><h6 style="color: #A0A2A2"><?php echo $rr['firma_v']; ?></h6></a>
							<h6><p><?php echo $rr['fecha_reg_not']; ?></p></h6>
						</div>
					</div>
